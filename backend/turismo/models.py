...
class UserProfile(AbstractBaseUser):
    ...
    # is_active requerido por AbstractBaseUser y CustomJWTAuthentication
...
class Review(models.Model):
    ...
    def __str__(self): return f"{self.user} - {self.place}"
...
class Tour(models.Model):
    ...
    slug        = models.SlugField(unique=True, blank=True)
    place       = models.ForeignKey(Place, on_delete=models.CASCADE, related_name='tours')
...
class Booking(models.Model):
    ...
    def __str__(self):
        return f"Reserva #{self.pk} - {self.tour.title} - {self.user.email}"